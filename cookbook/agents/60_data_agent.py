...
db_url = "mongodb://pesu_prod:jd7Aj5Zoixhay4uRaz@pesu.4gd.ai:27017/pesu-prod"

agent = Agent(
    model=OpenAIChat(id="gpt-4o"),
    # Store agent sessions in MongoDB
    storage=MongoAgentStorage(collection_name="agent_sessions", db_url=db_url, db_name="pesu-prod"),
    # Store memories in MongoDB
    memory=AgentMemory(
        db=MongoMemoryDb(collection_name="agent_sessions", db_url=db_url, db_name="pesu-prod"),
